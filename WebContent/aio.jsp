...
<body>
		...
		<%
			...
			try {
				...
				while (rs.next()) {
					...
					out.println("<tr><td>" + id + "</td><td>" + name + "</td><td>" + category + "</td><td>" + price
							+ "</td></tr>");
				}
	...
	<form name="form" action="aio.jsp" method="post">
		<select name="categories">
			...
			<%
				try {
					...
					con = DriverManager.getConnection(url, user, password);
					st = con.createStatement();
					String catQuery = "SELECT DISTINCT category FROM groceries";
